package com.geekbrains.artur.springMarket.service.model;
...
public class ProductInfo {
    ...
    public ProductRepr getProduct() { return product; }

    public void setProduct(ProductRepr product) { this.product = product; }
